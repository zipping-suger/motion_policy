...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="./checkpoints/cubby_6k_b16/last.ckpt", help="Path to the trained model checkpoint.")
    parser.add_argument("--val_data_path", type=str, default="./pretrain_data/ompl_cubby_6k", help="Path to the validation dataset directory.")
