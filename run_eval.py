...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="./checkpoints/table_leak_opt_goal/last.ckpt", help="Path to the trained model checkpoint.")
    parser.add_argument("--val_data_path", type=str, default="./pretrain_data/ompl_table_leak", help="Path to the validation dataset directory.")
